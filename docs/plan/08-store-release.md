...
`docs/privacy.md` および `docs/privacy.en.md` を新規作成。
...
- **GitHub Pagesの404**: 申請前に URL の到達性を確認。`/docs/privacy.md` を `privacy.html` として表示するため、Jekyll が動くか、もしくは生 Markdown を表示できる構成にする
